...
public class Main {
	...
	private void draw(Car C)
	{
        ...
        ImageIcon logo = new ImageIcon(Factory.getLogo());
		            ...
		            if (jc instanceof JLabel) {
		                ...
		                if(label.getName() != null )
		                {
		                	if(label.getName().equals("Preview"))
		                	{
		                		if(posModel == 0)
		                		{
		                			ImageIcon imgI = new ImageIcon(Factory.CreateSuv().getImage());
		    						label.setIcon(imgI);
		                		}
		                		if(posModel == 1)
		                		{
		                			ImageIcon imgI = new ImageIcon(Factory.CreateBerlina().getImage());
		    						label.setIcon(imgI);
		                		}
		                		if(posModel == 2)
		                		{
		                			ImageIcon imgI = new ImageIcon(Factory.CreateSport().getImage());
		    						label.setIcon(imgI);
		                		}
		                	}
		                	else if(label.getName().equals("Logo"))
		                	{
		                		...
		                		ImageIcon imgI = new ImageIcon(Factory.getLogo());
		    					label.setIcon(imgI);
		                	}
		                }
		            }
